            ...
            <el-container>
                <el-aside width="200px">
                    <el-menu
                            ...
                            text-color="#fff"
                            active-text-color="#ffd04b">
                        <div v-for="(menuItem, index) in leftMenu">
                            <el-submenu :index="menuItem.menuIndex" v-if="menuItem.menuItems.length > 0">
                            ...
                            <el-menu-item :index="menuItem.menuIndex" v-if="menuItem.menuItems.length === 0" @click="jump(menuItem.menuIndex)">
                                <i class="el-icon-menu"></i>
                                <span slot="title">{{ menuItem.menuName }}</span>
                            </el-menu-item>
                        </div>
